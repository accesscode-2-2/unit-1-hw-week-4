...
- (void)viewDidLoad {
    ...
    CQModel *model = [[CQModel alloc] init];
    [model setup];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Configure the cell...
    cell.textLabel.text = ((CQCategory*)self.categories[indexPath.row]).name;
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    CQOptionsTableViewController *optionsVC =  segue.destinationViewController;
    CQCategory *category = [self.categories objectAtIndex:indexPath.row];
    
    optionsVC.category = category;
