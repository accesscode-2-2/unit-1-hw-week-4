...
@interface CQDetailTableViewController ()
@property (nonatomic) NSIndexPath *checkedIndexPath;


@end

@implementation CQDetailTableViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    self.category.cqIndexPath = indexPath;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.checkedIndexPath isEqual:indexPath] || [self.category.cqIndexPath isEqual:indexPath]) {
